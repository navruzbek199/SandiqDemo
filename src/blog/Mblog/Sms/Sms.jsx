...
const Sms = () => {
    ...
    const onSend = () => {
        ...
        apiRoot.post(`bid/warehouse/to`, newdata, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        }).then((res) => {
                    ...
                    <Col md={{ span: 5, offset: 1 }}>
                        {
                            ...
                            <div className="send_btn gap-4">
                                ...
                                <button className='cancel' onClick={onCancel}>Oтменить заявка</button>
                            </div>
                            : null
                        }
                    </Col>
