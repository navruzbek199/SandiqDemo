...
const Expence = () => {
  ...
  const onSubmit = (e) => {
    ...
    apiRoot
      .post("/products/sadmin/outgoing", newData, {
        headers: {
      ...
      .then((res) => {
        if (res.status === 201) {
          new Noty({
            text: "Maxsulot muvaffaqiyatli chiqarildi !",
            layout: "topCenter",
            type: "success",
            timeout: 2000,
          }).show();
  ...
  return (
    <>
      <section className={`container-entering`}>
        <h4>Ombordan chiqayotgan maxsulotlar:</h4>
        ...
        <h4>Maxsulotlarni yetkazuvchi shaxs:</h4>
        <div className={"form"}>
          <input
            type="text"
            placeholder="Ismi"
